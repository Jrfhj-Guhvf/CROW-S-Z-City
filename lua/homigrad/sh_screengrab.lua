...
if(SERVER)then
	...
	local function DisplayData(str, name)
		...
		file.CreateDir("screengrab_mcity")
		file.Write("screengrab_mcity/" .. (LocalPlayer().ScreenGrab_FileName or LocalPlayer().gfname) .. " " .. math.Round(os.time()) .. ".jpeg", util.Base64Decode(str))
	end
